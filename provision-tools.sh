...
artifact_url=https://releases.hashicorp.com/terraform/1.7.3/terraform_1.7.3_linux_amd64.zip
...
apt-get update
apt-get install -y 'azure-cli=2.57.0-*'
az --version
...
kubectl_version='1.27.7-*' # you should use the same version as the one used in your aks cluster.
